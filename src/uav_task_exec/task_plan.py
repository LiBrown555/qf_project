...
"""
v1.1
任务计划执行文件,通过检测uav数据库中的任务计划task_plan表,
如果需要执行,则下发24小时以内任务到task_process表中,并根据任务计划类型进行执行
"""
import sys
import os
import json
...
log_path = log_config['log']['uav_task_plan']
...
class TaskPlan:
    def __init__(self,):
        ...
        self.log_init.log_init(log_path, "uav_task_plan")
